    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-xl-4">
                <div class="cs-iconbox cs-style1">
                    <div class="cs-iconbox_icon cs-center">
                        <img src="<?php echo get_template_directory_uri() ?>/img/icon_box_1.svg" alt="Icon">
                    </div>
                    <div class="cs-iconbox_in">
                        <div class="cs-iconbox_number cs-primary_font">01</div>
                        <h3 class="cs-iconbox_title">Thiết bị POS</h3>
                        <div class="cs-iconbox_subtitle">
                            Hiện tại, các dòng sản phẩm của AISINO đang được phân phối tại Việt Nam bởi ATOM Solution. Các dòng máy POS của AISINO đều được áp dụng các công nghệ tiên tiến hàng đầu trên thị trường hiện nay (Wifi 2.4GHz/5GHz, Android OS) cùng việc vận hành theo các chuẩn mật quốc tế hàng đầu (EMV, PIC-PDS…) nhằm hướng đến sự tiện lợi đa dạng, ứng dụng thực tế trong nhiều lĩnh vực.
                        </div>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="cs-iconbox cs-style1">
                    <div class="cs-iconbox_icon cs-center">
                        <img src="<?php echo get_template_directory_uri() ?>/img/icon_box_2.svg" alt="Icon">
                    </div>
                    <div class="cs-iconbox_in">
                        <div class="cs-iconbox_number cs-primary_font">02</div>
                        <h3 class="cs-iconbox_title">Hạ tầng POS</h3>
                        <div class="cs-iconbox_subtitle">ATOM Solution nỗ lực mang đến các tiện ích cho các đối tác thông qua việc cung cấp các hạ tầng liên quan đến POS. Các hạ tầng này phục vụ cho việc quản lý, cập nhật và theo dõi vận hành máy cũng như hướng đến việc xây dựng các công cụ quản lý, chăm sóc khách hàng.</div>
                    </div>
                </div>
                <div class="cs-height_25 cs-height_lg_25"></div>
            </div>
            <div class="col-md-6 col-xl-4">
                <div class="cs-iconbox cs-style1">
                    <div class="cs-iconbox_icon cs-center">
                        <img src="<?php echo get_template_directory_uri() ?>/img/icon_box_3.svg" alt="Icon">
                    </div>
                    <div class="cs-iconbox_in">
                        <div class="cs-iconbox_number cs-primary_font">03</div>
                        <h3 class="cs-iconbox_title">Cổng Thanh Toán Online</h3>
                        <div class="cs-iconbox_subtitle">ATOM Hub được xây dựng dựa trên mô hình cổng thanh toán đa kênh dễ dàng kết nối với các trang thương mại điện tử, website bán hàng… Các hình thức thanh toán trên ATOM HUB khá đa dạng, từ QR code, thẻ cho đến trả góp, mua trước trả sau... đáp ứng trên cả điện thoại và website.</div>
                    </div>
                </div>
                <div class="cs-height_25 cs-height_lg_25"></div>
            </div>
            <div class="col-md-6 col-xl-4">
                <div class="cs-iconbox cs-style1">
                    ...
                    <div class="cs-iconbox_in">
                        ...
                        <h3 class="cs-iconbox_title">Tư vấn & Triển khai</h3>
                        <div class="cs-iconbox_subtitle">Với việc hướng tới là người đồng hành lâu dài cùng đối tác, đội ngũ ATOM triển khai dịch vụ tư vấn hạ tầng cũng như mô hình kinh doanh cho đối tác. Sự tiện lợi, đơn giản với chi phí tối ưu, luôn đáp ứng tối đa nhu cầu của khách hàng với luôn là tiêu chí hàng đầu của ATOM Solution.</div>
                    </div>
                </div>
                <div class="cs-height_25 cs-height_lg_25"></div>
            </div>
            <div class="col-md-6 col-xl-4">
                <div class="cs-iconbox cs-style1">
                    ...
                    <div class="cs-iconbox_in">
                        <div class="cs-iconbox_number cs-primary_font">05</div>
                        <h3 class="cs-iconbox_title">Dịch vụ Nghiên cứu & Phát triển</h3>
                        <div class="cs-iconbox_subtitle">Bên cạnh đội ngũ kỹ sư phần mềm giàu kinh nghiệm và nhóm chuyên viên tư vấn giải pháp chuyên nghiệp, ATOM Solution đã và đang đầu tư xây dựng cho riêng mình đội ngũ R&D có chuyên môn cao trong việc nghiên cứu và phát triển các tính năng mới cũng như sản phẩm mới trên thị trường. Tập trung vào việc sáng tạo và nâng cấp những sản phẩm chất lượng theo nhu cầu của các khách hàng, mang đến những trải nghiệm dịch vụ tuyệt vời luôn là sứ mệnh cốt lõi của đội ngũ R&D ATOM.</div>
                    </div>
                </div>
                <div class="cs-height_25 cs-height_lg_25"></div>
            </div>
            <div class="col-md-6 col-xl-4">
                <div class="cs-iconbox cs-style1">
                    ...
                    <div class="cs-iconbox_in">
                        <div class="cs-iconbox_number cs-primary_font">06</div>
                        <h3 class="cs-iconbox_title">Hỗ trợ & Bảo trì</h3>
                        <div class="cs-iconbox_subtitle">Với phương châm trở thành người bạn tin cậy đồng hành và hợp tác lâu dài cùng đối tác của mình, ATOM Solution không chỉ dừng lại ở việc cung cấp những sản phẩm chất lượng mà còn hướng đến các dịch vụ hậu mãi. Đội ngũ chuyên viên giàu kinh nghiệm cùng kênh thông tin 24/7 sẽ luôn sẵn sàng để hỗ trợ khách hàng bất cứ khi nào khi nào sự cố xảy ra trong quá trình vận hành sản phẩm.</div>
                    </div>
                </div>
                <div class="cs-height_25 cs-height_lg_25"></div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="cs-iconbox cs-style2 text-center">
                                    <div class="cs-iconbox_icon"><img src="<?php echo get_template_directory_uri() ?>/img/retail_icon_1.svg" alt="Icon"></div>
                                    <h2 class="cs-iconbox_title">Giao đồ ăn</h2>
                                </div>
                                <div class="cs-height_25 cs-height_lg_25"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="cs-iconbox cs-style2 text-center">
                                    <div class="cs-iconbox_icon"><img src="<?php echo get_template_directory_uri() ?>/img/retail_icon_2.svg" alt="Icon"></div>
                                    <h2 class="cs-iconbox_title">Cửa hàng xe đạp</h2>
                                </div>
                                <div class="cs-height_25 cs-height_lg_25"></div>
                            </div>
                        </div>
                ...
                <div class="row wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInRight;">
                    <div class="col-lg-11">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="cs-iconbox cs-style2 text-center">
                                    <div class="cs-iconbox_icon"><img src="<?php echo get_template_directory_uri() ?>/img/retail_icon_3.svg" alt="Icon"></div>
                                    <h2 class="cs-iconbox_title">Cửa hàng quà tặng</h2>
                                </div>
                                <div class="cs-height_25 cs-height_lg_25"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="cs-iconbox cs-style2 text-center">
                                    <div class="cs-iconbox_icon"><img src="<?php echo get_template_directory_uri() ?>/img/retail_icon_4.svg" alt="Icon"></div>
                                    <h2 class="cs-iconbox_title">Cửa hàng nội thất</h2>
                                </div>
                                <div class="cs-height_25 cs-height_lg_25"></div>
                            </div>
                        </div>
                ...
                <div class="row wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInRight;">
                    <div class="col-lg-11 offset-lg-1">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="cs-iconbox cs-style2 text-center">
                                    <div class="cs-iconbox_icon"><img src="<?php echo get_template_directory_uri() ?>/img/retail_icon_5.svg" alt="Icon"></div>
                                    <h2 class="cs-iconbox_title">Cửa hàng quần áo</h2>
                                </div>
                                <div class="cs-height_25 cs-height_lg_25"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="cs-iconbox cs-style2 text-center">
                                    <div class="cs-iconbox_icon"><img src="<?php echo get_template_directory_uri() ?>/img/retail_icon_6.svg" alt="Icon"></div>
                                    <h2 class="cs-iconbox_title">Quán cà phê</h2>
                                </div>
                                <div class="cs-height_25 cs-height_lg_25"></div>
                            </div>
                        </div>
...
<section class="cs-gradient_bg_1">
    ...
    <div class="container">
        <div class="cs-seciton_heading cs-style1 text-center">
            <div class="cs-section_subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeInUp;">Testimonials</div>
            <div class="cs-height_10 cs-height_lg_10"></div>
        ...
        <div class="cs-slider cs-style1 cs-gap-24">
            <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-fade-slide="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
                <div class="cs-slider_wrapper slick-initialized slick-slider slick-dotted"><div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 4840px; transform: translate3d(-1320px, 0px, 0px);"><div class="slick-slide slick-cloned" data-slick-index="-3" id="" aria-hidden="true" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                            ...
                                            <div class="cs-testimonial_meta">
                                                ...
                                                <div class="cs-testimonial_meta_right">
                                                    ...
                                                    <div class="cs-review" data-review="5">
                                                        <img src="<?php echo get_template_directory_uri() ?>/img/stars.svg" alt="Star">
                                                        <div class="cs-review_in" style="width: 100%;">
                                                            <img src="<?php echo get_template_directory_uri() ?>/img/stars.svg" alt="Star">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="-2" id="" aria-hidden="true" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                                    <img src="<?php echo get_template_directory_uri() ?>/img/avatar_3.png" alt="Avatar">
                                                    <div class="cs-quote cs-center">
                                                        <svg width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M17.9033 0.470251C17.974 0.470231 18.0431 0.492568 18.1019 0.534429C18.1606 0.576288 18.2064 0.635782 18.2333 0.705356L18.9732 2.62083C19.0075 2.70954 19.0089 2.80875 18.9772 2.89853C18.9455 2.98831 18.8831 3.06201 18.8024 3.1048C17.5346 3.77738 16.6023 4.83665 16.0311 6.25297C15.8289 6.75453 15.6825 7.27956 15.595 7.81733L17.569 7.81733C17.6636 7.81733 17.7544 7.85732 17.8213 7.92851C17.8882 7.9997 17.9258 8.09624 17.9258 8.19692L17.9258 14.6207C17.9258 14.7213 17.8882 14.8179 17.8213 14.8891C17.7544 14.9603 17.6636 15.0002 17.569 15.0002L10.2806 15.0002C10.1859 15.0002 10.0952 14.9603 10.0283 14.8891C9.96136 14.8179 9.92377 14.7213 9.92377 14.6207L9.92377 10.2215C9.92329 8.5455 10.3244 6.897 11.0891 5.4317C11.8539 3.9664 12.9571 2.73265 14.2946 1.84695C15.2002 1.24811 16.1969 0.821584 17.24 0.586498C17.6221 0.499905 17.8567 0.473809 17.8665 0.472623C17.8787 0.47112 17.891 0.470328 17.9033 0.470251ZM18.19 2.59094L17.6794 1.26856C17.5984 1.28351 17.501 1.3032 17.3895 1.32859C13.4762 2.2142 10.6374 5.95429 10.6374 10.2215L10.6374 14.2411L17.2122 14.2411L17.2122 8.5765L15.1902 8.5765C15.1417 8.57658 15.0936 8.56612 15.049 8.54576C15.0044 8.52541 14.9642 8.49559 14.9308 8.45813C14.8974 8.42066 14.8715 8.37634 14.8548 8.32788C14.838 8.27942 14.8308 8.22783 14.8334 8.17628C14.8354 8.13571 14.8892 7.17133 15.3635 5.98228C15.6341 5.29767 16.0027 4.66176 16.4562 4.09717C16.9467 3.49086 17.5336 2.98102 18.19 2.59094Z" fill="currentColor"></path>
                                                            <path d="M8.42661 0.470251C8.4973 0.470278 8.56638 0.492638 8.6251 0.534494C8.68382 0.576352 8.72953 0.635819 8.75643 0.705356L9.49636 2.62083C9.53062 2.70954 9.53205 2.80875 9.50036 2.89853C9.46867 2.98831 9.40621 3.06201 9.32554 3.1048C8.05777 3.77738 7.12539 4.83665 6.55428 6.25297C6.3522 6.75461 6.20582 7.27961 6.11809 7.81733L8.09211 7.81733C8.18674 7.81733 8.27749 7.85732 8.34441 7.92851C8.41132 7.9997 8.44891 8.09624 8.44891 8.19692L8.44891 14.6207C8.44891 14.7213 8.41132 14.8179 8.34441 14.8891C8.27749 14.9603 8.18674 15.0002 8.09211 15.0002L0.802814 15.0002C0.708182 15.0002 0.617428 14.9603 0.550514 14.8891C0.483601 14.8179 0.446009 14.7213 0.446009 14.6207L0.446009 10.2215C0.442028 7.96623 1.16694 5.77803 2.49922 4.02375C3.8315 2.26946 5.69016 1.05573 7.76363 0.586024C8.14563 0.499431 8.38001 0.473334 8.38982 0.472148C8.40204 0.470806 8.41432 0.470174 8.42661 0.470251ZM8.71339 2.59094L8.2025 1.26856C8.12177 1.28351 8.02409 1.3032 7.91259 1.32859C3.99934 2.2142 1.15962 5.95429 1.15962 10.2215L1.15962 14.2411L7.7353 14.2411L7.7353 8.5765L5.71334 8.5765C5.6648 8.57658 5.61676 8.56612 5.57216 8.54576C5.52755 8.52541 5.48732 8.49559 5.45392 8.45813C5.42052 8.42066 5.39466 8.37634 5.37791 8.32788C5.36117 8.27942 5.35389 8.22783 5.35653 8.17628C5.35854 8.13571 5.41251 7.17133 5.88661 5.98228C6.15719 5.29767 6.5258 4.66177 6.97932 4.09717C7.46979 3.49073 8.05677 2.98087 8.71339 2.59094Z" fill="currentColor"></path>
                                                ...
                                                <div class="cs-testimonial_meta_right">
                                                    ...
                                                    <div class="cs-review" data-review="4.5">
                                                        <img src="<?php echo get_template_directory_uri() ?>/img/stars.svg" alt="Star">
                                                        <div class="cs-review_in" style="width: 90%;">
                                                            <img src="<?php echo get_template_directory_uri() ?>/img/stars.svg" alt="Star">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="-1" id="" aria-hidden="true" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                                    <img src="<?php echo get_template_directory_uri() ?>/img/avatar_1.png" alt="Avatar">
                                                    <div class="cs-quote cs-center">
                                                        <svg width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M17.9033 0.470251C17.974 0.470231 18.0431 0.492568 18.1019 0.534429C18.1606 0.576288 18.2064 0.635782 18.2333 0.705356L18.9732 2.62083C19.0075 2.70954 19.0089 2.80875 18.9772 2.89853C18.9455 2.98831 18.8831 3.06201 18.8024 3.1048C17.5346 3.77738 16.6023 4.83665 16.0311 6.25297C15.8289 6.75453 15.6825 7.27956 15.595 7.81733L17.569 7.81733C17.6636 7.81733 17.7544 7.85732 17.8213 7.92851C17.8882 7.9997 17.9258 8.09624 17.9258 8.19692L17.9258 14.6207C17.9258 14.7213 17.8882 14.8179 17.8213 14.8891C17.7544 14.9603 17.6636 15.0002 17.569 15.0002L10.2806 15.0002C10.1859 15.0002 10.0952 14.9603 10.0283 14.8891C9.96136 14.8179 9.92377 14.7213 9.92377 14.6207L9.92377 10.2215C9.92329 8.5455 10.3244 6.897 11.0891 5.4317C11.8539 3.9664 12.9571 2.73265 14.2946 1.84695C15.2002 1.24811 16.1969 0.821584 17.24 0.586498C17.6221 0.499905 17.8567 0.473809 17.8665 0.472623C17.8787 0.47112 17.891 0.470328 17.9033 0.470251ZM18.19 2.59094L17.6794 1.26856C17.5984 1.28351 17.501 1.3032 17.3895 1.32859C13.4762 2.2142 10.6374 5.95429 10.6374 10.2215L10.6374 14.2411L17.2122 14.2411L17.2122 8.5765L15.1902 8.5765C15.1417 8.57658 15.0936 8.56612 15.049 8.54576C15.0044 8.52541 14.9642 8.49559 14.9308 8.45813C14.8974 8.42066 14.8715 8.37634 14.8548 8.32788C14.838 8.27942 14.8308 8.22783 14.8334 8.17628C14.8354 8.13571 14.8892 7.17133 15.3635 5.98228C15.6341 5.29767 16.0027 4.66176 16.4562 4.09717C16.9467 3.49086 17.5336 2.98102 18.19 2.59094Z" fill="currentColor"></path>
                                                            <path d="M8.42661 0.470251C8.4973 0.470278 8.56638 0.492638 8.6251 0.534494C8.68382 0.576352 8.72953 0.635819 8.75643 0.705356L9.49636 2.62083C9.53062 2.70954 9.53205 2.80875 9.50036 2.89853C9.46867 2.98831 9.40621 3.06201 9.32554 3.1048C8.05777 3.77738 7.12539 4.83665 6.55428 6.25297C6.3522 6.75461 6.20582 7.27961 6.11809 7.81733L8.09211 7.81733C8.18674 7.81733 8.27749 7.85732 8.34441 7.92851C8.41132 7.9997 8.44891 8.09624 8.44891 8.19692L8.44891 14.6207C8.44891 14.7213 8.41132 14.8179 8.34441 14.8891C8.27749 14.9603 8.18674 15.0002 8.09211 15.0002L0.802814 15.0002C0.708182 15.0002 0.617428 14.9603 0.550514 14.8891C0.483601 14.8179 0.446009 14.7213 0.446009 14.6207L0.446009 10.2215C0.442028 7.96623 1.16694 5.77803 2.49922 4.02375C3.8315 2.26946 5.69016 1.05573 7.76363 0.586024C8.14563 0.499431 8.38001 0.473334 8.38982 0.472148C8.40204 0.470806 8.41432 0.470174 8.42661 0.470251ZM8.71339 2.59094L8.2025 1.26856C8.12177 1.28351 8.02409 1.3032 7.91259 1.32859C3.99934 2.2142 1.15962 5.95429 1.15962 10.2215L1.15962 14.2411L7.7353 14.2411L7.7353 8.5765L5.71334 8.5765C5.6648 8.57658 5.61676 8.56612 5.57216 8.54576C5.52755 8.52541 5.48732 8.49559 5.45392 8.45813C5.42052 8.42066 5.39466 8.37634 5.37791 8.32788C5.36117 8.27942 5.35389 8.22783 5.35653 8.17628C5.35854 8.13571 5.41251 7.17133 5.88661 5.98228C6.15719 5.29767 6.5258 4.66177 6.97932 4.09717C7.46979 3.49073 8.05677 2.98087 8.71339 2.59094Z" fill="currentColor"></path>
                                                ...
                                                <div class="cs-testimonial_meta_right">
                                                    ...
                                                    <div class="cs-review" data-review="4">
                                                        <img src="<?php echo get_template_directory_uri() ?>/img/stars.svg" alt="Star">
                                                        <div class="cs-review_in" style="width: 80%;">
                                                            <img src="<?php echo get_template_directory_uri() ?>/img/stars.svg" alt="Star">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    </div></div></div><div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" role="tabpanel" id="slick-slide00" tabindex="-1" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                    ...
                                    </div></div></div><div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false" role="tabpanel" id="slick-slide01" tabindex="-1" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                    ...
                                    </div></div></div><div class="slick-slide slick-active" data-slick-index="2" aria-hidden="false" role="tabpanel" id="slick-slide02" tabindex="-1" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                    ...
                                    </div></div></div><div class="slick-slide" data-slick-index="3" aria-hidden="true" role="tabpanel" id="slick-slide03" tabindex="-1" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="4" id="" aria-hidden="true" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="5" id="" aria-hidden="true" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="6" id="" aria-hidden="true" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="7" id="" aria-hidden="true" style="width: 440px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-testimonial cs-style1">
                                            <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the functionality of our website dramatically while were able to increase the.</div>
                                            <div class="cs-testimonial_meta">
                                                <div class="cs-avatar">
                ...
                <div class="cs-accordians cs-style1 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeIn;">
                  ...
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 -7.36618e-07C12.0333 -8.82307e-07 9.13319 0.879733 6.66645 2.52795C4.19971 4.17617 2.27713 6.51885 1.14181 9.25975C0.00649787 12.0006 -0.290551 15.0166 0.288226 17.9264C0.867005 20.8361 2.29562 23.5088 4.3934 25.6066C6.49119 27.7044 9.16393 29.133 12.0736 29.7118C14.9834 30.2905 17.9994 29.9935 20.7403 28.8582C23.4811 27.7229 25.8238 25.8003 27.472 23.3335C29.1203 20.8668 30 17.9667 30 15C29.9957 11.0231 28.414 7.21026 25.6019 4.39815C22.7897 1.58603 18.9769 0.00430081 15 -7.36618e-07V-7.36618e-07ZM15 20C14.085 20.0009 13.2014 19.6665 12.5163 19.06C12.1075 18.6962 11.72 18.3425 11.4663 18.0887L7.875 14.5587C7.75017 14.4457 7.64946 14.3086 7.57892 14.1557C7.50838 14.0028 7.46947 13.8372 7.46452 13.6689C7.45957 13.5005 7.48869 13.3329 7.55012 13.1762C7.61155 13.0194 7.70402 12.8766 7.822 12.7564C7.93998 12.6362 8.08102 12.5412 8.23667 12.4769C8.3923 12.4125 8.55934 12.3804 8.72773 12.3822C8.89612 12.3841 9.0624 12.4199 9.21659 12.4876C9.37078 12.5553 9.5097 12.6535 9.62501 12.7762L13.225 16.3125C13.46 16.5462 13.81 16.8637 14.1738 17.1875C14.4021 17.3889 14.6961 17.5001 15.0006 17.5001C15.3051 17.5001 15.5991 17.3889 15.8275 17.1875C16.19 16.865 16.54 16.5475 16.7675 16.3212L20.375 12.7762C20.4903 12.6535 20.6292 12.5553 20.7834 12.4876C20.9376 12.4199 21.1039 12.3841 21.2723 12.3822C21.4407 12.3804 21.6077 12.4125 21.7633 12.4769C21.919 12.5412 22.06 12.6362 22.178 12.7564C22.296 12.8766 22.3885 13.0194 22.4499 13.1762C22.5113 13.333 22.5404 13.5005 22.5355 13.6689C22.5305 13.8372 22.4916 14.0028 22.4211 14.1557C22.3505 14.3086 22.2498 14.4457 22.125 14.5587L18.5263 18.095C18.2763 18.345 17.8925 18.695 17.485 19.0562C16.8003 19.6647 15.916 20.0006 15 20Z" fill="currentColor"></path>
                        ...
                        <div class="cs-accordian-body" style="">
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard sincethe 15000s, printer took a galley of type and scrambl.
                        </div>
                    </div><!-- .cs-accordian -->
                </div>
...
<section class="cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/feature_bg.svg" id="news" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/feature_bg.svg');">
    ...
    <div class="container">
        <div class="cs-seciton_heading cs-style1 text-center">
            <div class="cs-section_subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeInUp;">Letest News</div>
            <div class="cs-height_10 cs-height_lg_10"></div>
        ...
        <div class="cs-slider cs-style1 cs-gap-24">
            <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-fade-slide="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="3" data-lg-slides="4" data-add-slides="4">
                <div class="cs-slider_wrapper slick-initialized slick-slider slick-dotted"><div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 4620px; transform: translate3d(-1320px, 0px, 0px);"><div class="slick-slide slick-cloned" data-slick-index="-4" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_2.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_2.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                                                    <li>
                      <span class="cs-medium">
                        <svg xmlns="http://www.w3.org/2000/svg" width="0.88em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 448 512"><path fill="currentColor" d="M313.6 304c-28.7 0-42.5 16-89.6 16c-47.1 0-60.8-16-89.6-16C60.2 304 0 364.2 0 438.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-25.6c0-74.2-60.2-134.4-134.4-134.4zM400 464H48v-25.6c0-47.6 38.8-86.4 86.4-86.4c14.6 0 38.3 16 89.6 16c51.7 0 74.9-16 89.6-16c47.6 0 86.4 38.8 86.4 86.4V464zM224 288c79.5 0 144-64.5 144-144S303.5 0 224 0S80 64.5 80 144s64.5 144 144 144zm0-240c52.9 0 96 43.1 96 96s-43.1 96-96 96s-96-43.1-96-96s43.1-96 96-96z"></path></svg>
                      </span>
                                                        admin
                                                    </li>
                                                    <li>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="-3" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_3.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_3.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                                                    <li>
                      <span class="cs-medium">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="-2" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_4.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_4.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                                                    <li>
                      <span class="cs-medium">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="-1" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_2.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_2.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" role="tabpanel" id="slick-slide20" tabindex="-1" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_1.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_1.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                                                    <li>
                      <span class="cs-medium">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false" role="tabpanel" id="slick-slide21" tabindex="-1" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_2.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_2.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-active" data-slick-index="2" aria-hidden="false" role="tabpanel" id="slick-slide22" tabindex="-1" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_3.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_3.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-active" data-slick-index="3" aria-hidden="false" role="tabpanel" id="slick-slide23" tabindex="-1" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_4.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_4.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide" data-slick-index="4" aria-hidden="true" role="tabpanel" id="slick-slide24" tabindex="-1" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_2.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_2.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="5" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_1.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_1.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="6" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_2.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_2.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="7" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_3.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_3.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="8" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_4.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_4.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.3 17.275q-.3-.3-.288-.725q.013-.425.313-.725L16.15 13H5q-.425 0-.713-.288Q4 12.425 4 12t.287-.713Q4.575 11 5 11h11.15L13.3 8.15q-.3-.3-.3-.713q0-.412.3-.712t.713-.3q.412 0 .712.3L19.3 11.3q.15.15.213.325q.062.175.062.375t-.062.375q-.063.175-.213.325l-4.6 4.6q-.275.275-.687.275q-.413 0-.713-.3Z"></path></svg>
                                    ...
                                    </div></div></div><div class="slick-slide slick-cloned" data-slick-index="9" id="" aria-hidden="true" style="width: 330px;"><div><div class="cs-slide" style="width: 100%; display: inline-block;">
                                        <div class="cs-post cs-style1">
                                            <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="<?php echo get_template_directory_uri() ?>/img/post_2.jpeg" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/post_2.jpeg');"></div></div>
                                            <div class="cs-post_info">
                                                <ul class="cs-post_meta cs-mp0">
