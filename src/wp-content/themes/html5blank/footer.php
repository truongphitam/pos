        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="cs-footer_item">
                    <div class="cs-footer_widget_text">
                        <img src="<?php echo get_template_directory_uri() ?>/img/logo_footer.svg" alt="Logo">
                        <p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="cs-footer_item widget_nav_menu">
                    ...
                    <ul class="menu">
                        <li><a href="https://posing-html.vercel.app/#">Food Delivery</a></li>
                        <li><a href="https://posing-html.vercel.app/#">Furniture Store</a></li>
                        <li><a href="https://posing-html.vercel.app/#">Coffee Shop</a></li>
                        <li><a href="https://posing-html.vercel.app/#">Clothing Store</a></li>
                        <li><a href="https://posing-html.vercel.app/#">eCommerce</a></li>
                    </ul>
                </div>
            </div><!-- .col -->
            <div class="col-lg-3 col-md-6">
                <div class="cs-footer_item widget_nav_menu">
                    ...
                    <ul class="menu">
                        <li><a href="https://posing-html.vercel.app/#">Features</a></li>
                        <li><a href="https://posing-html.vercel.app/#">FAQ</a></li>
                        <li><a href="https://posing-html.vercel.app/#">Privacy Policy</a></li>
                        <li><a href="https://posing-html.vercel.app/#">Terms of Use</a></li>
                    </ul>
                </div>
            </div><!-- .col -->
            <div class="col-lg-3 col-md-6">
        ...
        <div class="cs-modal_container cs-white_bg">
            ...
            <div class="cs-login">
                <div class="cs-login_left">
                    <img src="<?php echo get_template_directory_uri() ?>/img/about_img_1.png" alt="Login Thumb">
                </div>
                        ...
                        <div class="cs-social_btns cs-style2">
                            ...
                            <a href="https://posing-html.vercel.app/#" target="_blank" class="cs-center cs-color4">
                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M5.75391 5.35233L8.95236 5.2997L8.97726 6.78813H9.02292C9.45256 5.92498 10.5277 5.00288 12.1529 4.97762C15.5298 4.92078 16.1898 7.16707 16.2376 10.0997L16.333 16.0723L12.9976 16.127L12.9125 10.8302C12.8918 9.56706 12.844 7.94392 11.1317 7.97128C9.41936 7.99865 9.1516 9.38179 9.17443 10.8028L9.26161 16.1881L5.92825 16.2428L5.75391 5.35233Z" fill="currentColor"></path>
                                </svg>
                            </a>
                        </div>
                    </form>
...
<div class="cs-modal" data-modal="register">
    ...
    <div class="cs-modal_in">
        <div class="cs-modal_container cs-white_bg">
            ...
            <div class="cs-login">
                <div class="cs-login_left">
                    <img src="<?php echo get_template_directory_uri() ?>/img/retail-store.png" alt="Login Thumb">
                </div>
                <div class="cs-login_right">
                    <form class="cs-login_form">
        ...
        <div class="cs-modal_container cs-white_bg">
            ...
            <div class="cs-blog_details">
              ...
              <span class="cs-medium">
                ...
                <img src="<?php echo get_template_directory_uri() ?>/img/post_details_1.jpeg" alt="Details" class="cs-radius_10 w-100">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img src="<?php echo get_template_directory_uri() ?>/img/post_details_2.jpeg" alt="Details" class="cs-radius_10 w-100">
                    </div>
                    <div class="col-lg-6">
                        <img src="<?php echo get_template_directory_uri() ?>/img/post_details_3.jpeg" alt="Details" class="cs-radius_10 w-100">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img src="<?php echo get_template_directory_uri() ?>/img/post_details_4.jpeg" alt="Details" class="cs-radius_10 w-100">
                    </div>
                </div>
            </div>
                ...
                <div class="cs-comment_wrapper">
                    ...
                    <ol class="comment-list">
                        <li>
                            <div class="comment-body">
                                <div class="comment-author">
                                    <img alt="Avatar" src="<?php echo get_template_directory_uri() ?>/img/avatar_4.png" class="avatar">
                                    <cite class="fn"><a href="https://posing-html.vercel.app/#">Menila</a></cite>
                                </div>
                                <div class="comment-meta"><a href="https://posing-html.vercel.app/#">20 Apr, 2020</a> </div>
                                ...
                                <div class="reply"><a href="https://posing-html.vercel.app/#">Reply</a></div>
                            </div>
                            <ol class="children">
                                <li>
                                    <div class="comment-body">
                                        <div class="comment-author">
                                            <img alt="Avatar" src="<?php echo get_template_directory_uri() ?>/img/avatar_5.png" class="avatar">
                                            <cite class="fn"><a href="https://posing-html.vercel.app/#">Karla Swit</a></cite>
                                        </div>
                                        <div class="comment-meta"><a href="https://posing-html.vercel.app/#">9 May, 2020</a> </div>
                        ...
                        <li>
                            <div class="comment-body">
                                <div class="comment-author">
                                    <img alt="Avatar" src="<?php echo get_template_directory_uri() ?>/img/avatar_6.png" class="avatar">
                                    <cite class="fn"><a href="https://posing-html.vercel.app/#">George Steven</a></cite>
                                </div>
                                <div class="comment-meta"><a href="https://posing-html.vercel.app/#">November 24, 2020</a> </div>
                                <p>Great work</p>
                                <div class="reply"><a href="https://posing-html.vercel.app/#">Reply</a></div>
                            </div>
                        </li><!-- #comment-## -->
